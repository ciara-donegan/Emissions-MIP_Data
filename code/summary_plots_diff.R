...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_10p_red_1950_summary$shp_10p_red_1950[which(shp_10p_red_1950_summary$variable == "so2")] = shp_10p_red_1950_summary$shp_10p_red_1950[which(shp_10p_red_1950_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_20p_red_summary$shp_20p_red[which(shp_20p_red_summary$variable == "so2")] = shp_20p_red_summary$shp_20p_red[which(shp_20p_red_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_20p_red_1950_summary$shp_20p_red_1950[which(shp_20p_red_1950_summary$variable == "so2")] = shp_20p_red_1950_summary$shp_20p_red_1950[which(shp_20p_red_1950_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_80p_red_summary$shp_80p_red[which(shp_80p_red_summary$variable == "so2")] = shp_80p_red_summary$shp_80p_red[which(shp_80p_red_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_atl_shift_summary$shp_atl_shift[which(shp_atl_shift_summary$variable == "so2")] = shp_atl_shift_summary$shp_atl_shift[which(shp_atl_shift_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_atl_shift_1950_summary$shp_atl_shift_1950[which(shp_atl_shift_1950_summary$variable == "so2")] = shp_atl_shift_1950_summary$shp_atl_shift_1950[which(shp_atl_shift_1950_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_ind_shift_summary$shp_ind_shift[which(shp_ind_shift_summary$variable == "so2")] = shp_ind_shift_summary$shp_ind_shift[which(shp_ind_shift_summary$variable == "so2")] * 64.066 / 28.96
...
# Convert SO2 volume mixing ratio to mass mixing ratio by multiplying by molar mass
# of SO2 and dividing by molar mass of air
shp_ind_shift_1950_summary$shp_ind_shift_1950[which(shp_ind_shift_1950_summary$variable == "so2")] = shp_ind_shift_1950_summary$shp_ind_shift_1950[which(shp_ind_shift_1950_summary$variable == "so2")] * 64.066 / 28.96

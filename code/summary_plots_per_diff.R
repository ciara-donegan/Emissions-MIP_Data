...
setwd(paste0(emi_dir, '/input/', region, '/bc-no-seas/per-diff'))
...
setwd(paste0(emi_dir, '/input/', region, '/so2-at-hgt/per-diff'))
...
setwd(paste0(emi_dir, '/input/', region, '/so2-no-seas/per-diff'))
